...
import (
	...
	"ride-sharing/services/payment-service/infrastructure/stripe"
...
func main() {
	...
	// stripe processor
	stripProcessor := stripe.NewStripeClient(stripeCfg)

	// 创建支付服务,服务本身是看不到具体是哪个支付平台，用的都是Interface进行抽象的
	service := service.NewPaymentService(stripProcessor)
